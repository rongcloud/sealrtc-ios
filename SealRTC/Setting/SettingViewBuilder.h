...
@property (nonatomic, strong) UISwitch *gpuSwitch, *tinyStreamSwitch, *autoTestSwitch, *waterMarkSwitch, *audioScenarioSwitch , *videoMirrorSwitch, *audioCryptoSwitch, *videoCryptoSwitch, *srtpSwitch;
